...
9999 "Don't know";
 ...
 label define WORKPREG
   1 "Yes"
   5 "No"
   6 "R volunteers she worked during pregnancy, but quit job before delivery"
   8 "Refused"
   9 "Don't know";
...
9999 "Don't know";
 ...
 label define AGEQTNUR1
   ...
   2 "2 MONTHS OLD"
   3 "3 MONTHS OLD"
  96 "still breastfeeding this child"
  98 "Refused"
  99 "Don't know";
...
9999 "Don't know";
 ...
 label define WHYNOUSE1
   ...
   6 "Y1:Your male partner did not want to use a birth control method/Y2+:Your male partner himself did not want to use a birth control method"
   7 "(IF VOLUNTEERED:)Respondent was using a method"
   8 "Y1:[Not a response option]/Y2+:You could not get a method"
   9 "Y1:[Not a response option]/Y2+:You were not taking, or using, your method consistently"
  98 "Refused"
  99 "Don't know";
...
9999 "Don't know";
 ...
 label values PREGEND3 PREGEND3 ;
 ...
 label values PAYBIRTH4 PAYBIRTH4 ;
 ...
 label values MATWEEKS MATWEEKS ;
 label values WEEKSDK WEEKSDK ;
 label values MATLEAVE MATLEAVE ;
